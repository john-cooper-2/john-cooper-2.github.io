(function (window) {
    ...
    window.opspark.makeBackground = function(app,ground) {
        ...
        function render() {
            ...
            var backgroundImage = draw.bitmap("img/battlefield.jpg");
            ...
            // var shape = draw.circle(100, "cyan", "cyan", 1);
            // shape.x = 500;
            // shape.y = 400; 
        ...
        function update() {
            ...
            buildings[c].x = buildings[c].x -1;
            if(buildings[c].x < -100){
                buildings[c].x = canvasWidth;
            }
            }
        }
